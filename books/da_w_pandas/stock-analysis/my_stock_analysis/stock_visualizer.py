...
class Visualizer:
    ...
    def add_reference_line(ax, x=None, y=None, **kwargs):
        ...
        :param ax: `Axes` object to add the reference line to.
        :param x, y: The x, y value to draw the line at as a
        ...
        :param kwargs: Additional keyword args. to pass down.
        :return: The matplotlib `Axes` object passed in.
        """
        try:
    ...
    def shade_region(ax, x=tuple(), y=tuple(), **kwargs):
        ...
        :param ax: `Axes` object to add the shaded region to.
        :param x: Tuple with the `xmin` and `xmax` bounds for the rectangle drawn vertically.
        :param y: Tuple with the `ymin` and `ymax` bounds for the rectangle drawn horizontally.
        :param kwargs: Additional keywords args to pass down.
        :return: The matplotlib `Axes` object passed in.
        """
        if not x and not y:
            raise ValueError(
            ...
            raise ValueError(
                'You can only provide x or y.'
            )
        elif x and not y:
            ax.axvspan(*x, **kwargs)  # vertical region
        elif not x and y:
            ax.axspan(*y, **kwargs)  # horizontal region
        return ax
    ...
    def _iter_handler(items):
        ...
        :param items: The variable to make sure it is a list.
        :return: The input as a list or tuple.
        """
    ...
    def moving_average(self, column, periods, **kwargs):
        ...
        :param periods: The rule or list of rules for resampling,
                        like '20D', for 20-day periods.
        :param kwargs: Additional arguments to pass down.
    ...
    def exp_smoothing(self, column, periods, **kwargs):
        """
        Add lines(s) for the exponentially smoothed moving
        average of a column.

        :param column: The name of the column to plot.
        :param periods: The span or list of spans for, smoothing
...
class StockVisualizer(Visualizer):
    ...
    def candlestick(self, date_range=None, resample=None,
        ...
        :param date_range: String or `slice()` of dates to pass to `loc[]`,
                            if `None` the plot will be for the full range
                            of the data.
        :param resample: The offset to use for resampling the data, if desired.
        :param volume: Whether to show a bar plot for volume traded under the candlesticks.
        :param kwargs: Keyword args for `mplfinance.plot()`
        :return: -
        """
        if not date_range:
            date_range = slice(
    ...
    def fill_between(y1, y2, title, label_higher, label_lower, figsize, legend_x):
        ...
        :param y1, y2: Data to plot, filling y2 - y1.
        :param title: The title for the plot.
        :param label_higher: Label for when y2 > y1.
        :param label_lower: Label for when y2 <= y1.
        :param figsize: (width, height) for the plot dimensions.
        :param legend_x: Where to place legend below the plot.
        :return: A matplotlib `Axes` object.
        """
        is_higher = y2 - y1 > 0
    ...
    def fill_between_other(self, other_df, figsize=(10, 4)):
        ...
        :param other_df: The other asset's data.
        :param figsize: (width, height) for the plot.
        :return: A matplotlib `Axes` object.
        """
        ax = self.fill_between(
    ...
    def _window_calc(self, column, periods, name, func,
        ...
        :param column: The name of the column to plot.
        :param periods: The rule/span or list of them to pass to the
                        resampling/smoothing function, like '20D' for
                        2-day span (smoothing)
        :param name: The name of the window calculation (to show in the legend).
        :param func: The window calculation function.
        :param named_arg: The name of the argument `periods` is being passed as.
        :param kwargs: Additional arguments to pass down.
        :return: A matplotlib `Axes` object.
        """
    ...
    def joinplot(self, other, column, **kwargs):
        """
        Generate a seaborn joinplot for given column in
        this asset compared to another asset.

        :param other: The other asset's dataframe.
        :param column: Column to use for the comparison.
        :param kwargs: Keyword arguments to pass down.
        :return: A seaborn joinplot.
        """
    ...
    def correlation_heatmap(self, other):
        """
        Plot the correlations between this asset and another one with a heatmap.

        :param other: The other dataframe.
        :return: A seaborn heatmap.
        """
    ...
    def boxplot(self, **kwargs):
        ...
        :param kwargs: Additional keyword arguments to pass down
...
class AssetGroupVisualizer(Visualizer):
    ...
    def _get_layout(self):
        ...
        :return: `Figure` and `Axes` objects to plot with.
        """
    ...
    def _window_calc(self, column, periods, name, func,
        ...
        :param column: The name of the column to plot.
        :param periods: The rule/span or list of them to pass to the resampling/smoothing function,
                        like '20D' for 20-day periods (resampling) or 20 for a 20-day span (smoothing).
        :param name: The name of the window calculation (to show in the legend).
        :param func: The window calculation function.
        :param named_arg: The name of the argument `periods` is being passed as.
        :param kwargs: Additional arguments to pass down.
